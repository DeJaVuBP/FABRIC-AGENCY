...
function generateHeaderCategoryTable() {
    ...
    var first_row = "<tr>";
    first_row += "<th style='width: 25%;' rowspan='2'>Tên Loại Vải</th>";
    first_row += "<th style='width: 25%;' rowspan='2'>Màu Sắc</th>";
    first_row += "<th style='width: 16%;' rowspan='2'>Số lượng</th>";
    first_row += "<th style='width: 34%;' colspan='2'>Giá Bán</th>";
    first_row += "</tr>";
    var second_row = "<tr>";
    second_row += "<th>Ngày</th>";
    second_row += "<th>Giá</th>";
    second_row += "</tr>";
...
function generateBodySupplierTable(data) {
    ...
    var row = "<tr>";
    row += "<td style='width: 25%;' rowspan='" + rowspan + "'>Nhà Cung Cấp</td>";
    row += "<td style='width: 20%;'>Tên</td>";
    row += "<td style='width: 55%;'>" + data['name'] + "</td>";
    row += "</tr>";
    if (numbers_of_phone > 0) {
        row += "<tr>";
        row += "<td rowspan='" + numbers_of_phone + "'>SĐT</td>";
