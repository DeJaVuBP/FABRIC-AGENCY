...
class Transaction
{
    ...
    {
        $sql = "SELECT category.categoryName, relationprovide_provideinformation.date as Date, relationprovide_provideinformation.purchasePrice, relationprovide_provideinformation.quantity as Quantity, supplier.supplierName, supplier.supplierCode FROM category, relationprovide_provideinformation, supplier WHERE category.categoryCode = relationprovide_provideinformation.categoryCode AND relationprovide_provideinformation.r_supplierCode = supplier.supplierCode ";
