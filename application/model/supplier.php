...
class Supplier
{
    ...
    static function inputNewSupplier($input_data)
    {
        ...
        $bankAccount = (isset($input_data["bank_account"]) && $input_data["bank_account"] != null) ? $input_data["bank_account"] : "";
        $taxCode = (isset($input_data["tax"]) && $input_data["tax"] != null) ? $input_data["tax"] : "";
        $result = $GLOBALS['db_conn']->queryData(
